function docReady() {
    ...
    ***/
    ...
    //用于修改工程的模态框
    $('#supervisorbutton1').click(function (e){
        e.preventDefault();
        $("#supervisor1").modal('show');
    });
    ...
    // $("#major123").append("<option value='值1'>值1</option>");
    $("#major option[value='3']").attr("selected",true);
   ...
   // $('#major').attr("selected",true);
    ...
    //点击查询按钮
    $('#nightworkQuery').click(function(e){
    	e.preventDefault();
    	$('#accordion').show();
    });
